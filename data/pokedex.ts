export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	castform: {
		...
		otherFormes: ["Castform-Sunny", "Castform-Rainy", "Castform-Snowy", "Castform-Rocky"],
		formeOrder: ["Castform", "Castform-Sunny", "Castform-Rainy", "Castform-Snowy", "Castform-Rocky"],
	},
	castformsunny: {
		num: 351,
		name: "Castform-Sunny",
