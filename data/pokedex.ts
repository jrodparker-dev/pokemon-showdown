...
castformmega: {
  ...
  eggGroups: ["Fairy", "Amorphous"],
	...
	jirachi: {
		...
		types: ["Steel", "Psychic"],
		gender: "N",
		baseStats: { hp: 100, atk: 100, def: 100, spa: 150, spd: 100, spe: 100 },
	...
	ribombee: {
		...
		name: "Ribombee",
		types: ["Bug", "Fairy"],
		baseStats: { hp: 60, atk: 105, def: 60, spa: 95, spd: 70, spe: 124 },
		abilities: { 0: "Honey Gather", 1: "Shield Dust", H: "Sweet Veil" },
		heightm: 0.2,
		weightkg: 0.5,
		color: "Yellow",
	...
	miraidon: {
		...
		types: ["Electric", "Dragon"],
		gender: "N",
		baseStats: { hp: 110, atk: 95, def: 110, spa: 145, spd: 125, spe: 145 },
